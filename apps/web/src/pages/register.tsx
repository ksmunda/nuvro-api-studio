    ...
    <div className="flex min-h-screen items-center justify-center bg-surface-950 px-4">
      <div className="w-full max-w-md space-y-8 rounded-2xl border border-surface-800 bg-surface-900/50 p-8 shadow-xl backdrop-blur-md">
        <div className="text-center">
          <h2 className="text-3xl font-extrabold tracking-tight text-brand-400">Create Account</h2>
          <p className="mt-2 text-sm text-surface-400">Get started with NUVRO API Studio</p>
        </div>
